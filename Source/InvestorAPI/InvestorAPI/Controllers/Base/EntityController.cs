...
namespace InvestorAPI.Controllers
{
        ...
        where TUpdateDto : class
    {
        ...
        protected IEntityService<TEntity, TOutputDto, TCreateDto, TUpdateDto> EntityService { get; }

        #endregion

        #region Constructor

        public EntityController(IEntityService<TEntity, TOutputDto, TCreateDto, TUpdateDto> entityService)
        {
